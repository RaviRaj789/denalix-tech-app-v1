...
export default function FloatingLines({
  ...
  useEffect(() => {
    ...
    try {
      ...
      return setupFloatingLines({ scene, camera, renderer });
    } catch (err) {
      console.error("FloatingLines: failed to initialize WebGL, skipping background effect.", err);
      return () => {
        active = false;
      };
    }

    function setupFloatingLines({ scene, camera, renderer }) {
